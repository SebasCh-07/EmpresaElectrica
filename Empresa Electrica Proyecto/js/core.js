/* ========================================
   CORE - Plataforma TAT
   Funcionalidades principales y configuración
   ======================================== */

// Configuración global
const CONFIG = {
    APP_NAME: 'Plataforma TAT',
    VERSION: '1.0.0',
    API_BASE_URL: '/api',
    STORAGE_PREFIX: 'tat_',
...
class PlataformaTAT {
    ...
    // Placeholder para métodos que se implementarán en otros módulos
    loadTickets() { console.log('loadTickets llamado desde core.js'); }
    ...
    loadDashboard() { this.showAlert('Cargando dashboard...', 'info'); }
